ig.module('game.entities.ui.sign-combo')
.requires(
	'game.entities.ui.base-ui'
)
.defines(function() {
    EntitySignCombo = EntityBaseUi.extend({
        zIndex: 5001,
        size: {x: 236, y: 81},
		animSheet: new ig.AnimationSheet( 'media/graphics/sprites/ui/txt-combo.png', 236, 81 ),
		textScale: 1,
		enabled: false,
